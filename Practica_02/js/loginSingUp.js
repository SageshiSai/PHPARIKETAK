...
function renderlogin() {
    //Enseña la tabla del formulario
    ...
    //Envia los datos resibidos del formulario//
    document.querySelector('#form-container').addEventListener('submit', async (event) => {
    event.preventDefault();
    //Resibe los datos de telefono (El boton) y despues llama la fucion pushSetDataelefono para guardarlo en la base de datos//
}); 
}
